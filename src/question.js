export default [
    ...
    },
    {
        ...
        answers: [
            'To perform side effects in function components, such as data fetching or subscriptions.',
            'To manage component state and trigger re-renders.',
            'To handle form validation and error messages.',
            'To style React components with inline CSS.',
        ],
    },
    {
        id: 'q9',
        text: 'How can you improve the performance of a React application?',
        answers: [
            'By using React.memo to prevent unnecessary re-renders of components.',
            'By rendering all components on the initial load.',
            'By removing all functional components and using class components.',
            'By increasing the number of states in the app.',
        ],
    },
    {
        id: 'q10',
        ...
        answers: [
            'A lightweight copy of the actual DOM that React uses to efficiently update the UI.',
            'A physical DOM element used for rendering web pages.',
            'A third-party library used to manipulate DOM elements.',
            'A feature that allows React to directly manipulate the real DOM without re-rendering.',
        ],
    },
